...
public class Borrower extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField3.getText().length() < 3 || jTextField3.getText().length() > 64) {
         ...
         if (jTextField5.getText().length() < 3 || jTextField5.getText().length() > 64) {
            JOptionPane.showMessageDialog(null,"Address should be between 3 and 64 characters.");
            return;
        }
          if (jTextField6.getText().length() < 1 || jTextField6.getText().length() > 32) {
        ...
        try (PreparedStatement preparedStatement = myConn.prepareStatement("INSERT INTO BORROWER VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);")) {
